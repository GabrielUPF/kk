<?php define('APP_PATH', 'http://localhost/estudo_caso'); ?>
<!DOCTYPE html>
<html lang="en"><head>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?= APP_PATH ?>/pessoa/controladorPessoa.php">Pessoa</a></li>
            <li><a href="<?= APP_PATH ?>/tarefa/controladorTarefa.php">Tarefa</a></li>
            <li class="dropdown">
